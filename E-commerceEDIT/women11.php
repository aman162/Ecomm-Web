		...
		<div id="slider" class="carousel slide carousel-fade" data-ride="carousel">
  			<div class="carousel-inner">
    			<div class="carousel-item active">
      				<img src="women1.jpg" class="d-block w-100" alt="..." width="900" height="385">
    			</div>
    			<div class="carousel-item">
      				<img src="women2.jpg" class="d-block w-100" alt="..." width="900" height="385">
   			</div>
    			<div class="carousel-item">
      				<img src="women3.jpg" class="d-block w-100" alt="..." width="900" height="385">
    			</div>
  			</div>
...
$con = mysqli_connect('127.0.0.1:3306','root','','ecomm') or die('Unable To connect');
   ...
   $res=mysqli_query($con,"select * from product where description='saree'");
   ...
   {  
    ...
    echo '<form action="add_to_cartw1.php?action='.$x.'" method = "post">';
   ...
   <button style="padding:5px; background-color:orange;border-radius:10px;"href="ecomm.php">Add To Cart</button> &nbsp;&nbsp;
