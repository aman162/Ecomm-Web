...
<div class="topnav">
  ...
  <?php
     ...
     $name = $_SESSION['name'];
     echo '  <div style = "float:right;text-color:orange">
     <a href="logout.php">'.$name.'</a></div>';
     }
     else{
       echo '<div style = "float:right;text-color:orange">
...
<section class="header">
  ...
  <div class="dropdown-container">
    <a href="men11.php">T Shirts</a>
    <a href="men22.php">Shirts</a>
    <a href="men33.php">Trousers</a>
  </div>
		...
		<div id="slider" class="carousel slide carousel-fade" data-ride="carousel">
  			<div class="carousel-inner">
    			<div class="carousel-item active">
      				<img src="acc1.jpg" class="d-block w-100" alt="..." width="900" height="385">
    			</div>
    			<div class="carousel-item">
      				<img src="acc2.jpg" class="d-block w-100" alt="..." width="900" height="385">
    			</div>
    			<div class="carousel-item">
      				<img src="acc3.jpg" class="d-block w-100" alt="..." width="900" height="385">
    			</div>
  			</div>
...
<section class= "featured-categories">
    ...
    <div class ="row">
        <div class="col-md-4">
           <a href="men11.php"> <img src="s1.jpg" ></a>
        </div>
        <div class="col-md-4">
        <a href="women11.php"> <img src="s2.jpg" ></a>
		</div>
		<div class="col-md-4">
    <a href="acc11.php"> <img src="s3.jpg" ></a>
        </div>
    </div>
...
$con = mysqli_connect('127.0.0.1:3306','root','','ecomm') or die('Unable To connect');
   ...
   $res=mysqli_query($con,"select * from product where description='watch'");
   ...
   echo '<form action="add_to_carta1.php?action='.$x.'" method = "post">';
   ...
   <button style="padding:5px; background-color:orange;border-radius:10px;"href="ecomm1.php?id=<?php echo $row["id"]; ?>">Add To Cart</button>&nbsp;&nbsp;
   <br>
   <?php
   echo "</td>";
   echo '</form>';
