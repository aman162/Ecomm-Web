		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action = "" method ="POST"  enctype="multipart/form-data">
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Product Name">
					...
					<input class="input100" type="text" name="name" placeholder="Enter Product Name">
        </div>
        
        <div class="wrap-input100 validate-input bg1" data-validate="Please Type Description ">
					<span class="label-input100">DESCRIPTION *</span>
					<input class="input100" type="text" name="desc" placeholder="Enter Product Description ">
        </div>
...
$mx = "SELECT id FROM product";
$mx1 = mysqli_query($con,$mx);

while($row = mysqli_fetch_array($mx1)){
  $x = $row['id'];
}
$x++;

    $sql = "insert into product (id,photo,name,price,description) values('$x',?,'$name','$price','$desc')";
