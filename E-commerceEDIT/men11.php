...
$con = mysqli_connect('127.0.0.1:3306','root','','ecomm') or die('Unable To connect');
   ...
   echo '<form action="add_to_cart.php?action='.$x.'" method = "post">';
  ...
  <button type = "submit" style="padding:5px; background-color:orange;border-radius:10px;">Add To Cart</button>&nbsp;&nbsp;
   <br>
   <?php
   echo "</td>";
   echo '</form>';
