...
<div class="topnav">
  ...
  <a class="active" href="cont.php">Contact</a>
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" action="contact.php" method="post">
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input class="input100" type="text" name="email_id" placeholder="Enter email addess" required>
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate = "Message is required">
					...
					<textarea class="input100" type="text" name="message" placeholder="Your Comment..." required></textarea>
					<span class="focus-input100"></span>
				</div>
