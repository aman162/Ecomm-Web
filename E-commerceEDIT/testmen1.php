...
$con = mysqli_connect('127.0.0.1:3306','root','','ecomm') or die('Unable To connect');
   ...
   $y=$row['price'];
       ...
       $sql = "insert into cart (name,price,quantity) values('$x',$y,1)";
   ...
   <a href="buy.php"><button style="padding:5px; background-color:orange;border-radius:10px;">Buy Now</button></a>  
   <br>
   <?php
   echo "</td>";
   } 
