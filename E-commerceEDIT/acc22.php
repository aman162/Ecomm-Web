		...
		<div id="slider" class="carousel slide carousel-fade" data-ride="carousel">
  			<div class="carousel-inner">
    			...
    			<div class="carousel-item">
      				<img src="acc4.jpg" class="d-block w-100" alt="..." width="900" height="385">
    			</div>
    			<div class="carousel-item">
      				<img src="acc5.jpg" class="d-block w-100" alt="..." width="900" height="385">
    			</div>
  			</div>
...
$con = mysqli_connect('127.0.0.1:3306','root','','ecomm') or die('Unable To connect');
   ...
   $res=mysqli_query($con,"select * from product where description='shoes'");
   ...
   {  
    ...
    echo '<form action="add_to_cart2.php?action='.$x.'" method = "post">';
   ...
   <button style="padding:5px; background-color:orange;border-radius:10px;"href="ecomm2.php?id=<?php echo $row["id"]; ?>">Add To Cart</button>&nbsp;&nbsp;
